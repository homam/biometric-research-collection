...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/NOW.ts":[function(require,module,exports) {
"use strict";
...
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/log.ts":[function(require,module,exports) {
"use strict";
...
exports.log = log;
},{}],"src/header.ts":[function(require,module,exports) {
"use strict";

var _a;
(_a = document.getElementById("channelNameForm")) === null || _a === void 0 ? void 0 : _a.addEventListener("submit", function (ev) {
  ev.preventDefault();
...
},{"_bundle_loader":"node_modules/parcel-bundler/src/builtins/bundle-loader.js","cross-fetch":[["browser-ponyfill.74474147.js","node_modules/cross-fetch/dist/browser-ponyfill.js"],"browser-ponyfill.74474147.js.map","node_modules/cross-fetch/dist/browser-ponyfill.js"]}],"node_modules/@supabase/functions-js/dist/module/types.js":[function(require,module,exports) {
"use strict";
...
exports.CustomAuthError = exports.AuthUnknownError = exports.AuthSessionMissingError = exports.AuthRetryableFetchError = exports.AuthPKCEGrantCodeExchangeError = exports.AuthInvalidCredentialsError = exports.AuthImplicitGrantRedirectError = exports.AuthError = exports.AuthApiError = void 0;
  ...
  exchangeCodeForSession(authCode) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const {
        data,
        error
      } = yield (0, _fetch._request)(this.fetch, 'POST', `${this.url}/token?grant_type=pkce`, {
        headers: this.headers,
        body: {
          auth_code: authCode,
  ...
  reauthenticate() {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        const {
          error
        } = yield (0, _fetch._request)(this.fetch, 'GET', `${this.url}/reauthenticate`, {
          headers: this.headers,
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        if ('email' in credentials) {
          ...
          const {
            error
          } = yield (0, _fetch._request)(this.fetch, 'POST', endpoint, {
            headers: this.headers,
            body: {
              email,
              type,
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        if (isPKCEFlow) {
          ...
          if (!authCode) throw new _errors.AuthPKCEGrantCodeExchangeError('No code detected.');
          const {
            data,
            error
          } = yield this.exchangeCodeForSession(authCode);
          if (error) throw error;
          if (!data.session) throw new _errors.AuthPKCEGrantCodeExchangeError('No session detected.');
...
exports.newVisitor = void 0;
var supabase_js_1 = require("@supabase/supabase-js");
// Create a single supabase client for interacting with your database
var supabase = (0, supabase_js_1.createClient)("https://bnpndeyqgieoapeqhfll.supabase.co", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJucG5kZXlxZ2llb2FwZXFoZmxsIiwicm9sZSI6ImFub24iLCJpYXQiOjE2ODUxMDI3NDMsImV4cCI6MjAwMDY3ODc0M30.hwODZJIC_b-mV5gW4QKgiLVkYUa6dR-Epg8XlT4JCzI", {
  realtime: {
    params: {
      eventsPerSecond: 10
    }
...
function newVisitor(_x) {
  return _newVisitor.apply(this, arguments);
}
function _newVisitor() {
  _newVisitor = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(channelName) {
    var _a, _yield$supabase$auth$, data, error, channel;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 2:
          ...
          channel = supabase.channel(channelName || data.session.user.email, {
            config: {
              broadcast: {
                ack: true,
                self: true
...
},{"@supabase/supabase-js":"node_modules/@supabase/supabase-js/dist/module/index.js"}],"src/send.ts":[function(require,module,exports) {
"use strict";
...
exports.send = void 0;
var telemetry = __importStar(require("./telemetry"));
var channel = null;
telemetry.newVisitor(localStorage.getItem("channelName")).then(function (_ref) {
  var user = _ref.user,
    nchannel = _ref.channel;
  ...
  channel.on("presence", {
    ...
    var newPresences = _ref2.newPresences;
    console.log("New users have joined: ", newPresences);
  });
  channel.on("presence", {
    event: "leave"
  }, function (_ref3) {
    var leftPresences = _ref3.leftPresences;
    console.log("Users have left: ", leftPresences);
  });
}).catch(console.log);
function send(eventType, event) {
  if (channel) {
    channel.send(_objectSpread({
      type: "broadcast",
      event: eventType
    }, event));
  }
...
exports.send = send;
},{"./telemetry":"src/telemetry.ts"}],"src/start.ts":[function(require,module,exports) {
"use strict";
...
function startRecording(timeStamp) {
  ...
  if (!isStartedRecording) {
    ...
    (0, send_1.send)("start", {
      ...
      mediaQueries: !window.matchMedia ? null : {
        ...
        display_mode: {
          ...
          minimal_ui: window.matchMedia("(display-mode: minimal-ui)").matches,
          browser: window.matchMedia("(display-mode: browser)").matches
        }
      },
      devicePixelRatio: window.devicePixelRatio,
      ui: {
        menubar: (_a = window.menubar) === null || _a === void 0 ? void 0 : _a.visible,
        toolbar: (_b = window.toolbar) === null || _b === void 0 ? void 0 : _b.visible,
        locationbar: (_c = window.locationbar) === null || _c === void 0 ? void 0 : _c.visible,
        scrollbars: (_d = window.scrollbars) === null || _d === void 0 ? void 0 : _d.visible
      }
    });
  }
}
...
},{"./send":"src/send.ts"}],"src/devicemotion.ts":[function(require,module,exports) {
"use strict";
...
window.addEventListener("devicemotion", function (ev) {
  {
    ...
    if (acc) {
      accelerationIncludingGravity = {
        time: ev.timeStamp || new Date().valueOf() - NOW_1.NOW,
        x: acc.x,
        y: acc.y,
        z: acc.z
      };
  ...
  {
    var _acc = ev.acceleration;
    if (_acc) {
      totalAcceleration = {
        time: ev.timeStamp || new Date().valueOf() - NOW_1.NOW,
        x: totalAcceleration.x + Math.abs(_acc.x || 0),
        y: totalAcceleration.y + Math.abs(_acc.y || 0),
        z: totalAcceleration.z + Math.abs(_acc.z || 0)
      };
    }
  }
});
setInterval(function () {
  if (accelerationIncludingGravity.time != null || totalAcceleration.time != null) {
    (0, send_1.send)("acceleration", {
      accelerationIncludingGravity: accelerationIncludingGravity,
      totalAcceleration: totalAcceleration
    });
  }
}, 500);
},{"./send":"src/send.ts","./NOW":"src/NOW.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
...
setInterval(function () {
  if (mousemove.time != null) {
    (0, send_1.send)("mousemove", _objectSpread(_objectSpread({}, mousemove), {}, {
...
function onTouchCompleted(touchStart, touchMove, touchEnd) {
  (0, log_1.log)(JSON.stringify({
    touchStart: touchStart,
    touchMove: touchMove,
    touchEnd: touchEnd
  }, null, 2));
  (0, send_1.send)("touchEnd", {
    start: touchStart,
    end: touchEnd
  });
}
...
document.addEventListener("touchend", function (ev) {
  var touch0 = ev.changedTouches[0];
  touchEnd = {
    time: ev.timeStamp || new Date().valueOf() - NOW_1.NOW,
    screen: {
      x: touch0.screenX,
...
function onScrollCompleted(scrollStart, scrollEnd) {
  (0, log_1.log)(JSON.stringify({
    scrollStart: scrollStart,
    scrollEnd: scrollEnd
  }, null, 2));
  (0, send_1.send)("scrollEnd", {
    start: scrollStart,
    end: scrollEnd
  });
}
...
},{"./NOW":"src/NOW.ts","./style.css":"src/style.css","./log":"src/log.ts","./header":"src/header.ts","./send":"src/send.ts","./start":"src/start.ts","./devicemotion":"src/devicemotion.ts"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
var b=require("node_modules/parcel-bundler/src/builtins/bundle-loader.js");b.register("js",require("node_modules/parcel-bundler/src/builtins/loaders/browser/js-loader.js"));b.load([["browser-ponyfill.74474147.js","node_modules/cross-fetch/dist/browser-ponyfill.js"]]).then(function(){require("src/index.ts");});
